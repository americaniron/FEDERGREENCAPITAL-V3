                                                                ...
                                                                <div className="space-y-1.5 pl-3 border-l border-brand-gold/10">
                                                                    {sub.subItems.slice(0, 4).map(deep => (
                                                                        <button 
                                                                            ...
                                                                            className="block text-[8px] text-white/30 hover:text-brand-gold transition-colors font-bold tracking-[0.2em] uppercase text-left"
                                                                        >
                                                                            {deep.label}
                                                                        </button>
                                                                    ))}
                                    ...
                                    <div className="grid grid-cols-1 gap-1 py-4 pl-4 border-l border-brand-gold/20 animate-fade-in bg-white/5 rounded-r-2xl">
                                        {item.subItems.map((sub) => (
                                            <button 
                                                key={sub.path} 
                                                onClick={() => handleNav(sub.path)}
                                                className="block w-full text-left py-3 px-4 text-sm font-bold text-white/40 active:text-brand-gold hover:text-white uppercase tracking-widest"
                                            >
                                                {sub.label}
                                            </button>
                                        ))}
